...
export class BiographyComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.meta.updateTag({ name: 'description', content: 'Bodrum ve Muğla\'ta yaşayan ressam Nilüfer Örel hakkında. Biyografi, sergiler ve sanatsal teknikler. Turkish painter based in Bodrum, Muğla.' });
